...
var arr = ["Let Us C Solutions","Password Strength Checker","Soccer 'C' Game","Equations Solver","Matrix Rank Finder","Chat App (Windows)","Automatic Mouse Alphabet Writer","Chat App (Android)","Tic-Tac-Toe (Android)"];
var links = ["Let Us C Solutions.zip","Password Strength Checker.zip","Soccer Game.zip","Equations Solver.zip","Matrix Rank Finder.zip","Chat App.zip","alphabetWriter_pyautogui.zip","chat_app_android.zip","tictactoe_android.zip"];
